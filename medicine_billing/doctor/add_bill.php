...
<head>
    ...
    <!-- IMPORTANT: go up one level to root style.css -->
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card p-4">
                ...
                <button id="saveBill" class="btn btn-success w-100 mt-3">💾 Save & Generate Bill</button>
            </div>
        </div>
    </div>
</div>
...
document.getElementById('saveBill').onclick = function() {
    ...
    .catch(err => {
        console.error(err);
        alert('Error saving bill (check console)');
    });
};
</script>
</body>
